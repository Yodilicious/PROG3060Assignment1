 ...
 *  PROG3060
 *   @author Jodi Visser
 *   Assignment 1: JDBC Application using CanadaCensusDB
 *		Login.jsp
...
<link href="PROG3060Assignment1JV/css/signin.css" rel="stylesheet">
<title>Assignment 1 - Canada Census</title>
</head>
<body class="text-center">
    <div class="container">
	    <form class="form-signin" method="get" action="loginprocess">
	      ...
	      <p class="mt-5 mb-3 text-muted">&copy; Assignment 1 JV - 2018</p>
	    </form>
	</div>
